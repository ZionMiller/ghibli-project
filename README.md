...
"Ghibli Films" utilizes the Ghibli API to provide Studio Ghibli fans a one stop shop for every Ghibli film. Users are able to do and observe the following;
...
* Users can toggle between light and dark mode via the theme selector option
...
* Event Listeners (each has own cb function): 
    ...
    * Toggle theme - uers can change between light and dark mode
